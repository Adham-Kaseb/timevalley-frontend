...
export default function AdminSidebar({ isOpen = false, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        data-lenis-prevent
        className={`fixed lg:sticky top-0 left-0 z-40 w-72 lg:w-64 bg-[#0E6875] text-white flex flex-col justify-between shrink-0 shadow-2xl transition-transform duration-300 ease-in-out h-screen self-start ${
      ...
      >
        <div className="flex flex-col h-full overflow-hidden">
          ...
          {/* Navigation Section */}
          <nav className="px-4 mt-6 space-y-1.5 flex-1 overflow-y-auto menu-scrollbar" data-lenis-prevent>
