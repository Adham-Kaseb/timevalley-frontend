...
export default function TopBar() {
  return (
    <div className="bg-[#0E6875] text-white text-xs py-1.5 sm:py-2 px-3 sm:px-4 border-b border-white/10 hidden sm:block relative z-50" suppressHydrationWarning>
